...
export interface ModifySharedEnvelope {
  ...
  /** In signing view, button to move on to next mandatory field. */
  hideNextRequiredFieldbtn?: boolean;
}

export const modifySharedEnvelopeSchema: Schema<ModifySharedEnvelope> = object({
